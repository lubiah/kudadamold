...
<section>
    <div class="text-center">
        ...
        <img class="w-80 mx-auto my-3" loading="lazy" src="https://kudadam.sirv.com/svg/boy.svg?q=1" alt="Cartoonish boy winking his eye" >
        <div class="py-3">
            <p>
...
<section>
    ...
    <div class="flex flex-wrap md:flex-row-reverse mb-2">
        <div class="w-full md:w-1/2">
            <img loading="lazy" src="https://kudadam.sirv.com/svg/showing_resume.svg?q=1" alt="" style="max-height: 400px;width: 100%" />
        </div>
...
<section>
    ...
    <div class="my-5"><img class="block mx-auto" src="https://kudadam.sirv.com/svg/dev.svg?q=1" loading="lazy" style="height: 300px;" alt="developer in front of a computer"/></div>
