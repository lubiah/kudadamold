		...
		{#each tools as tool (tool.id)}
			<li class="">
				<p class="text-lg font-semibold ">
					<a class="visited:text-[color:var(--primary-color)] dark:visited:text-[color:var(--primary-color)] hover:no-underline hoverable py-3 px-2 block" href={tool.url} sveltekit:prefetch>
