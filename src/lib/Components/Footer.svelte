<footer class="bg-gray-800 text-gray-400 text-base pt-4 mt-8">
	...
	<div class="text-center">
		<p class="pb-1">
			<span class="block md:inline">Made with <i class="fas fa-heart text-red-500 animate-pulse"></i> and built with <a href="https://kit.svelte.dev" target="_blank">SvelteKit</a></span>
