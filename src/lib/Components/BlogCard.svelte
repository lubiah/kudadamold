...
<div id="card"class="w-full md:w-1/2 lg:w-1/3 px-2 mb-9 relative">
	<a sveltekit:prefetch href="blog/{slug}" class="hover:text-red-500 text-black dark:text-white dark:hover:text-red-500" id="card-title">
	...
	<div>
		<h2 class="text-xl mx-1 my-2 font-semibold"><a rel="prefetch" href="blog/{slug}" class="hover:text-red-500 text-black dark:text-white dark:hover:text-red-500" id="card-title">{title}</a></h2>
